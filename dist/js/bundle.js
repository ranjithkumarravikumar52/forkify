...
"use strict";
eval("\n\nvar _test = __webpack_require__(/*! ./test */ \"./src/js/test.js\");\n\nvar _test2 = _interopRequireDefault(_test);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n//x value will hold 23 coming from test module\nvar y = 23; // Global app controller\n\nconsole.log('I imported ' + _test2.default + ' from another module! Variable y is ' + y); //this command works only if we use some kind of bundler tools\n\n//# sourceURL=webpack:///./src/js/index.js?");
